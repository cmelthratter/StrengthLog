...
class WeightEditorDialog : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        builder.setMessage(R.string.weight_editor_desc)
                .setPositiveButton(R.string.lift_dialog_submit, DialogInterface.OnClickListener { _, _ ->
                    ...
                    mListener!!.onDialogPositiveClick(textInput.text.toString().toFloat())
    ...
    interface WeightEditorDialogListener {
        fun onDialogPositiveClick(newWeight: Float)
        fun onDialogNegativeClick()
    }

    // Use this instance of the interface to deliver action events
    var mListener: WeightEditorDialogListener? = null
    ...
    override fun onAttach(activity: Activity) {
        ...
        try {
            ...
            mListener = activity as WeightEditorDialogListener
